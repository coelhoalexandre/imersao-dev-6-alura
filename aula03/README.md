<h1 align="center"> Imersão Dev 6 | Aula 03</h1>
...
Projeto realizado enquanto assistia a aula 03 da Imersão Dev 6 e posteriormente modificado por mim.

Enquanto este ReadMe está sendo escrito, a aula ainda está liberada. Pode ser acessada através deste link: <a href="https://imersao.dev/aulas/aula03-aluraflix-filmes-array">Imersão Dev 6 - Aula 03</a>.

## Modificações

- Adicionei um botão onde um prompt é exibido, como resposta você tem que colocar o link da imagem.

- Nenhuma verificação null foi adicionada, então se apertar cancelar ele irá executar a imagem vazia.

- O mais interessante destas modificações é que você pode adicionar quantos filmes quiser!
